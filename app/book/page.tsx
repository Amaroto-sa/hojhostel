      ...
      <div className="container mx-auto px-4 w-[92%] max-w-[1180px] py-14">
        <div className="glass p-10 max-w-lg mx-auto text-center">
          ...
          {typeof success === 'string' && (
            <div className="inline-block bg-[rgba(255,255,255,0.06)] border border-[rgba(255,255,255,0.1)] rounded-lg px-4 py-2 mb-6">
              <span className="text-[#b1b1ba] text-sm">Booking Reference: </span>
              <strong className="text-white font-mono tracking-wider">{success.substring(success.length - 8).toUpperCase()}</strong>
            </div>
          )}
