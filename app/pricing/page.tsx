  ...
  const plans = [
    {
      ...
      price: "₦30,000",
      period: "/ week",
      features: ["Shared accommodation", "Access to all amenities", "CCTV security", "Storage & wardrobe", "Cleaning services", "High-speed Wi-Fi"],
      featured: false,
    },
    {
      title: "14 Bed Spaces",
      price: "₦40,000",
      period: "/ week",
      features: ["Premium shared space", "Extra ventilation", "Access to all amenities", "CCTV security", "Storage & wardrobe", "Kitchen access"],
      featured: false,
    },
    {
      title: "Single Room A",
      price: "₦40,000",
      period: "/ week",
      features: ["Private room", "Standard size", "Personal space", "All amenities included", "Steady electricity", "Parking space"],
      featured: false,
    },
    {
      title: "Single Room B",
      price: "₦70,000",
      period: "/ week",
      features: ["Premium private room", "Maximum privacy", "Enhanced features", "All amenities included", "Priority support", "Best-in-class comfort"],
      featured: true,
    },
  ];
  ...
  return (
    <div className="container mx-auto px-4 w-[92%] max-w-[1180px] py-14">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-14">
        {plans.map((plan) => (
          <div key={plan.title} className={`glass p-7 relative overflow-hidden transition-transform hover:-translate-y-1 ${plan.featured ? 'border-[#ff7a1a]/30' : ''}`}>
            {plan.featured && (
            ...
            <div className="flex items-baseline gap-1 mb-6">
              <span className="text-[#ff7a1a] text-3xl font-bold">{plan.price}</span>
              <span className="text-[#b1b1ba] text-sm">{plan.period}</span>
            </div>
            ...
            <Link href="/book" className={`block text-center w-full py-3 rounded-full font-bold text-sm transition ${
              plan.featured 
