...
export default function LoginPageClient() {
    ...
    return (
        <div className="min-h-[80vh] flex items-center justify-center px-4 py-8 relative">
            <Link
                href="/"
                className="absolute top-8 left-8 text-[#b1b1ba] hover:text-[#ff7a1a] transition-colors flex items-center gap-2 text-sm font-medium group"
            >
            ...
            <div className="glass p-8 md:p-10 w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    ...
                    <div className="flex items-center justify-between text-xs mt-1">
                        <label className="flex items-center gap-2 cursor-pointer group">
                            <input
                                type="checkbox"
                                className="w-4 h-4 rounded border-white/10 bg-white/5 accent-[#ff7a1a]"
                            />
                        ...
                        <button
                            type="button"
                            className="text-[#ff7a1a] hover:underline hover:text-[#ff9f5a]"
                            onClick={() =>
                                alert("Password reset is currently only handled by Admin. Contact helpdesk.")
                            }
                        >
                            Forgot password?
                        </button>
                ...
                <div className="mt-8 text-center text-sm text-[#b1b1ba]">
                    ...
                    <Link href="/register" className="text-[#ff7a1a] hover:underline font-semibold">
                        Create one
                    </Link>
                </div>
            </div>
